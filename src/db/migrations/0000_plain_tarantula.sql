...
--> statement-breakpoint
ALTER TABLE "assignment_submissions" ADD CONSTRAINT "assignment_submissions_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "certificates" ADD CONSTRAINT "certificates_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "communities" ADD CONSTRAINT "communities_owner_id_instructors_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."instructors"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "enrollments" ADD CONSTRAINT "enrollments_enrolled_by_id_parents_id_fk" FOREIGN KEY ("enrolled_by_id") REFERENCES "public"."parents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "parent_child_links" ADD CONSTRAINT "parent_child_links_parent_id_parents_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."parents"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "withdrawals" ADD CONSTRAINT "withdrawals_instructor_id_instructors_id_fk" FOREIGN KEY ("instructor_id") REFERENCES "public"."instructors"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "instructor_replies" ADD CONSTRAINT "instructor_replies_instructor_id_instructors_id_fk" FOREIGN KEY ("instructor_id") REFERENCES "public"."instructors"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_user_id_students_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_user_credentials_entity" ON "user_credentials" USING btree ("entity_id","entity_type");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_community_member" ON "community_members" USING btree ("community_id","entity_id","entity_type");--> statement-breakpoint
CREATE INDEX "idx_community_members_community" ON "community_members" USING btree ("community_id");--> statement-breakpoint
CREATE INDEX "idx_community_members_entity" ON "community_members" USING btree ("entity_id","entity_type");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_instructors_email" ON "instructors" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_conversation_participant" ON "conversation_participants" USING btree ("conversation_id","entity_id","entity_type");--> statement-breakpoint
...
CREATE INDEX "idx_conversation_participants_entity" ON "conversation_participants" USING btree ("entity_id","entity_type");--> statement-breakpoint
...
CREATE INDEX "idx_notifications_entity" ON "notifications" USING btree ("entity_id","entity_type");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_parents_email" ON "parents" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_payments_reference" ON "payments" USING btree ("reference");--> statement-breakpoint
CREATE INDEX "idx_payments_payer" ON "payments" USING btree ("payer_id","payer_type");--> statement-breakpoint
